function drawChart() {
	...
	//d3.csv("../Excel/d3-example.csv").then(function(prices) { // load from csv file 
	d3.json("../PHP/d3-example-action.php").then(function(prices) { // load from json data from live URL
